...
/**
 * Navigation strategy for viewing the charity page.
 * 
 * This class implements the INavigationStrategy interface and handles 
 * the navigation by forwarding the request to the "views/charity.jsp" page.
 * 
 * Author: Robin Guan
 * Version: 1.0
 * Since: 17.0.8
 */
public class ViewCharityStrategy implements INavigationStrategy {
    
	/**
     * Navigates to the charity page.
     * 
