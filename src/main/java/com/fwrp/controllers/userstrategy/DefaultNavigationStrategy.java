...
/**
 * Default navigation strategy to forward requests to the index page.
 * 
 * This class implements the INavigationStrategy interface and handles 
 * the navigation by forwarding the request to the "index.jsp" page.
 * 
 * Author: Robin Guan
 * Version: 1.0
 * Since: 17.0.8
 */
public class DefaultNavigationStrategy implements INavigationStrategy {
