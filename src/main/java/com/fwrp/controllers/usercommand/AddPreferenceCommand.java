...
/**
 * Command to add a preference for a user.
 * 
 * This class implements the IUserCommand interface and handles the
 * execution of adding a preference by retrieving the user from the session,
 * adding the preference, and managing the preference view.
 * 
 * @author Ke Yan
 * @version 2.0
 */
public class AddPreferenceCommand implements IUserCommand {
    ...
    /**
     * Executes the command to add a preference.
     * 
    ...
    public void execute(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            req.setAttribute("errorMessage", "Preference Already Exists.");
